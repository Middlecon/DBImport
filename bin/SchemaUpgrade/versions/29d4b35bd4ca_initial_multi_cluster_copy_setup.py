...
def upgrade():
    ...
    sa.Column('hdfs_address', sa.String(length=64), nullable=False, comment='HDFS address. Example hdfs://hadoopcluster'),
    sa.Column('hdfs_basedir', sa.String(length=64), nullable=False, comment='The base dir to write data to. Example /apps/dbimport'),
