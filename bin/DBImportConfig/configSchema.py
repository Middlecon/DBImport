...
class importTables(Base):
    ...
    invalidate_impala = Column(TINYINT(4), nullable=False, comment='-1 = Use default value from configuration table, otherwise 1 will invalidate the table in Impala and 0 will not', server_default=text("'-1'"))
    ...
    sourceTableType = Column(String(16), comment='Type of table on the source system. This is a read-only')
