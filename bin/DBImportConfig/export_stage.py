...
#validate
		...
		elif stage == 102: stageDescription = "Create Export Temp table"
		elif stage == 103: stageDescription = "Truncate Export Temp table"
		elif stage == 104: stageDescription = "Insert data into Export Temp table" 
		elif stage == 105: stageDescription = "Create Target table"
		elif stage == 106: stageDescription = "Truncate Target table"
		elif stage == 107: stageDescription = "Sqoop Export"
		elif stage == 108: stageDescription = "Validations"

		# Export_Phase_INCR
		elif stage == 150: stageDescription = "Getting Hive tableschema"
		elif stage == 151: stageDescription = "Clear table rowcount"
		elif stage == 152: stageDescription = "Create Export Temp table"
		elif stage == 153: stageDescription = "Truncate Export Temp table"
		elif stage == 154: stageDescription = "Fetching the Max value from Hive"
		elif stage == 155: stageDescription = "Insert data into Export Temp table" 
		elif stage == 156: stageDescription = "Create Target table"
		elif stage == 157: stageDescription = "Sqoop Export"
		elif stage == 158: stageDescription = "Validations"
		elif stage == 159: stageDescription = "Saving pending incremental values"
	...
	def getStageShortName(self, stage):
		...
		elif stage == 102: stageShortName = "create_temp_table"
		elif stage == 103: stageShortName = "truncate_temp_table"
		elif stage == 104: stageShortName = "insert_into_temp_table"
		elif stage == 105: stageShortName = "create_target_table"
		elif stage == 106: stageShortName = "truncate_target_table"
		elif stage == 107: stageShortName = "sqoop"
		elif stage == 108: stageShortName = "validate"

		# Export_Phase_INCR
		elif stage == 150: stageShortName = "get_hive_tableschema"
		elif stage == 151: stageShortName = "clear_table_rowcount"
		elif stage == 152: stageShortName = "create_temp_table"
		elif stage == 153: stageShortName = "truncate_temp_table"
		elif stage == 154: stageShortName = "fetch_maxvalue"
		elif stage == 155: stageShortName = "insert_into_temp_table"
		elif stage == 156: stageShortName = "create_target_table"
		elif stage == 157: stageShortName = "sqoop"
		elif stage == 158: stageShortName = "validate"
		elif stage == 159: stageShortName = "skip"
